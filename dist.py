...
parser.add_argument('--data', metavar='DIR', default='/home/zhaoyu/Data/Imagenet/ILSVRC2012', help='path to dataset')
...
def train(train_loader, model, criterion, optimizer, epoch, local_rank, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        if i % args.print_freq == 0:
            ...
            speed = int(args.print_freq * args.batch_size / time_step) * args.nprocs
            print(args.batch_size, time_step, speed)
            time_prev = timer()
